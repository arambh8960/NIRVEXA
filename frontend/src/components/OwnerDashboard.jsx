...
function OwnerDashboard() {
  ...
  return (
    <div className='w-full min-h-screen flex flex-col items-center'>
        ...
        <div className='flex justify-center items-center p-4 sm:p-6'>
          <div className='w-full max-w-md bg-white shadow-lg rounded-2xl p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300'>
            <div className='flex flex-col items-center text-center'>
              <FaWarehouse className='text-[#ff4d2d] w-16 h-16 sm:w-20 sm:h-20 mb-4' />
              <h2 className='text-xl sm:text-2xl font-bold text-gray-800 mb-2'>
                Add Your Material Store
              </h2>
              <p className='text-gray-600 mb-4 text-sm sm:text-base'>
                Register your construction material shop and start selling cement,
                steel, bricks and more to nearby customers.
              </p>
              <button
      ...
      {/* SHOP EXISTS */}
      {myShopData &&
        <div className='w-full flex flex-col items-center gap-6 px-4 sm:px-6 pt-[80px]'>
          <h1 className='text-2xl sm:text-3xl text-gray-900 flex items-center gap-3 mt-8 text-center'>
            <FaWarehouse className='text-[#ff4d2d] w-14 h-14' />
            ...
            <div className='flex justify-center items-center p-4 sm:p-6'>
              <div className='w-full max-w-md bg-white shadow-lg rounded-2xl p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300'>
                <div className='flex flex-col items-center text-center'>
                  ...
                  <p className='text-gray-600 mb-4 text-sm sm:text-base'>
                    Add cement, TMT bars, bricks and other materials to your inventory.
                  </p>
                  <button
                    className='bg-[#ff4d2d] text-white px-5 sm:px-6 py-2 rounded-full font-medium shadow-md hover:bg-orange-600 transition-colors duration-200'
